// Derived from OpenAI Codex codex-rs/apply-patch/src/file_update.rs.
// Licensed under Apache-2.0; modified to operate on caller-provided text only.
...
pub fn apply_update(
    ...
    match update_file_mode {
        ApplyPatchFileUpdateMode::NormalizeToLf => {
            ...
            let replacements =
                compute_replacements(&original_lines, path, chunks, update_file_mode)?;
